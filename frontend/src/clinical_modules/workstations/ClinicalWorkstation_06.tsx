...
export interface WorkstationProps_6 {
...
export const ClinicalWorkstation_6: React.FC<WorkstationProps_6> = (props) => {
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <div>
          <h3 className="text-base font-bold text-slate-900">Clinical Workstation Matrix 6</h3>
