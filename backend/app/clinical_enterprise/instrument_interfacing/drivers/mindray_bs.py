"""
AcuPath Enterprise LIS - Mindray BS-800M High-Throughput Modular Chemistry Analyzer Driver
...
logger = logging.getLogger("acupath.driver.mindray_bs")


class MindrayBSDriver:
    """Driver implementation for Mindray BS-800M High-Throughput Modular Chemistry Analyzer Driver."""

    def __init__(self, instrument_id: str = "MINDRAYBSDRIVER-01", host: str = "192.168.1.100", port: int = 5100):
