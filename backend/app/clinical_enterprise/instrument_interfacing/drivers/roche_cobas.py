"""
AcuPath Enterprise LIS - Roche Cobas 6000/8000 Clinical Chemistry & Immunochemistry Analyzer Driver
...
logger = logging.getLogger("acupath.driver.roche_cobas")


class RocheCobasDriver:
    """Driver implementation for Roche Cobas 6000/8000 Clinical Chemistry & Immunochemistry Analyzer Driver."""

    def __init__(self, instrument_id: str = "ROCHECOBASDRIVER-01", host: str = "192.168.1.100", port: int = 5100):
