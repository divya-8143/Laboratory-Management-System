"""
AcuPath Enterprise LIS - Siemens ADVIA 2120i High-Volume Hematology System Driver
...
logger = logging.getLogger("acupath.driver.siemens_advia")


class SiemensAdviaDriver:
    """Driver implementation for Siemens ADVIA 2120i High-Volume Hematology System Driver."""

    def __init__(self, instrument_id: str = "SIEMENSADVIADRIVER-01", host: str = "192.168.1.100", port: int = 5100):
