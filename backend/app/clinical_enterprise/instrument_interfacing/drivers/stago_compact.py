"""
AcuPath Enterprise LIS - Diagnostica Stago STA Compact Max Automated Coagulation Analyzer Driver
...
logger = logging.getLogger("acupath.driver.stago_compact")


class StagoCompactDriver:
    """Driver implementation for Diagnostica Stago STA Compact Max Automated Coagulation Analyzer Driver."""

    def __init__(self, instrument_id: str = "STAGOCOMPACTDRIVER-01", host: str = "192.168.1.100", port: int = 5100):
