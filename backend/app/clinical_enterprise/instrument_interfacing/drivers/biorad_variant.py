"""
AcuPath Enterprise LIS - Bio-Rad Variant II HPLC Dual-Program Hemoglobin Testing Driver
...
logger = logging.getLogger("acupath.driver.biorad_variant")


class BioRadVariantDriver:
    """Driver implementation for Bio-Rad Variant II HPLC Dual-Program Hemoglobin Testing Driver."""

    def __init__(self, instrument_id: str = "BIORADVARIANTDRIVER-01", host: str = "192.168.1.100", port: int = 5100):
