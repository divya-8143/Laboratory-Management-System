"""
AcuPath Enterprise LIS - Abbott Architect c4000/i2000SR Integrated Chemistry/Immunoassay Driver
...
logger = logging.getLogger("acupath.driver.abbott_architect")


class AbbottArchitectDriver:
    """Driver implementation for Abbott Architect c4000/i2000SR Integrated Chemistry/Immunoassay Driver."""

    def __init__(self, instrument_id: str = "ABBOTTARCHITECTDRIVER-01", host: str = "192.168.1.100", port: int = 5100):
