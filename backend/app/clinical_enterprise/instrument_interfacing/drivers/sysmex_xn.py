"""
AcuPath Enterprise LIS - Sysmex XN-1000/2000 5-Part Differential Hematology Analyzer Driver
...
logger = logging.getLogger("acupath.driver.sysmex_xn")


class SysmexXNDriver:
    """Driver implementation for Sysmex XN-1000/2000 5-Part Differential Hematology Analyzer Driver."""

    def __init__(self, instrument_id: str = "SYSMEXXNDRIVER-01", host: str = "192.168.1.100", port: int = 5100):
